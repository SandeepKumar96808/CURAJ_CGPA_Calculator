...
class Aboutus(object):
    ...
    def __init__(self, root):
        self._images.append(tkinter.PhotoImage(
            'about-us (1).gif', file='about-us (1).gif'))

        # Widget Initialization
        self._frame_1 = tkinter.Frame(root, background="#ffff77",)
        self._labelframe_1 = tkinter.LabelFrame(
            root, background="#f1fd60", font="{Lucida Sans Unicode} 8 bold", text="License",)
        ...
        self._label_5 = tkinter.Label(root,
                                      ...
                                      text="""Curaj CGPA Calculator designed by Sandeep Kumar.
                                      \uD83D\uDC8C Email ID - sandeepkumar96808@gmail.com
 \uD83D\uDCDE Phone number - +919680833221
 \uD83C\uDF10 Whats app - +919680833221""",)
        ...
        self._label_1 = tkinter.Label(self._labelframe_1,
                                      ...
                                      For more information regarding permissions, write us to or call: +919680833221.""",)

        # widget commands
        self.close.configure(command=self.close_command)

        # Geometry Management
        self._frame_1.grid(in_=root, column=1, row=4, columnspan=1,
                           ipadx=0, ipady=0, padx=0, pady=0, rowspan=1, sticky="news")
        self._labelframe_1.grid(in_=root, column=1, row=3, columnspan=2,
                                ipadx=0, ipady=0, padx=0, pady=0, rowspan=1, sticky="news")
        self._label_4.grid(in_=root, column=1, row=1, columnspan=2,
                           ipadx=0, ipady=0, padx=0, pady=0, rowspan=1, sticky="nsew")
        self._label_5.grid(in_=root, column=1, row=2, columnspan=2,
                           ipadx=0, ipady=0, padx=0, pady=0, rowspan=1, sticky="nsew")
        self.close.grid(in_=root, column=2, row=4, columnspan=1,
                        ipadx=0, ipady=0, padx=0, pady=0, rowspan=1, sticky="nsew")
        self._label_1.grid(in_=self._labelframe_1, column=1, row=1, columnspan=1,
