...
class Main(object):
    ...
    def __init__(self, root):
        self._images.append(tkinter.PhotoImage(
            'Screenshot_(117).gif', file='Curajdisc.gif'))
        self._images.append(tkinter.PhotoImage(
            'Screenshot_(119).gif', file='Screenshot_(119).gif'))

        # Widget Initialization
        self._labelframe_3 = tkinter.LabelFrame(
            root, background="#fafdb3", font="{MS Sans Serif} 8 bold", foreground="#000000", text="Student Details",)
        ...
        self._frame_51 = tkinter.Frame(root, background="#ffffb0",)
        self._frame_52 = tkinter.Frame(root, background="#ffffb0",)
        self._frame_53 = tkinter.Frame(root, background="#ffffb0",)
        self._frame_54 = tkinter.Frame(root, background="#ffffb0",)
        ...
        self._label_5 = tkinter.Label(self._labelframe_3, activebackground="#fafdb3",
                                      background="#fafdb3", font="{MS Sans Serif} 8 bold", text="Name:",)
        ...
        self._label_10 = tkinter.Label(
            root, activebackground="#ffffff", background="#ffffff", image="Screenshot_(119).gif", text="_label_10",)
        self._label_12 = tkinter.Label(self._frame_1, activebackground="#ffffae", activeforeground="#ff0000", background="#ffffae",
                                       font="{MS Sans Serif} 8 bold", foreground="#ff0000", text="Semester Courses :",)
        self._label_13 = tkinter.Label(
            root, activebackground="#b87070", background="#b87070", font="{MS Sans Serif} 8 bold", text="Course Title",)
        self._label_14 = tkinter.Label(
            root, activebackground="#b87070", background="#b87070", font="{MS Sans Serif} 8 bold", text="Course Code",)
        self._label_16 = tkinter.Label(
            root, activebackground="#b87070", background="#b87070", font="{MS Sans Serif} 8 bold", text="Credit",)
        self._label_20 = tkinter.Label(root, activebackground="#b87070", background="#b87070",
                                       font="{MS Sans Serif} 8 bold", text="Grade Obtained",)
        self.firstsub1 = tkinter.Entry(
            self._frame_2, justify="center", width=35,)
        self.firstcourse1 = tkinter.Entry(
            self._frame_3, justify="center", width=10,)
        self.firstcredit1 = tkinter.Entry(
            self._frame_4, justify="center", width=0,)
        self.firstgrade1 = tkinter.Entry(
            self._frame_5, justify="center", width=0,)
        self.firstsub2 = tkinter.Entry(
            self._frame_6, justify="center", width=35,)
        self.firstcourse2 = tkinter.Entry(
            self._frame_7, justify="center", width=10,)
        self.firstcredit2 = tkinter.Entry(
            self._frame_8, justify="center", width=0,)
        self.firstgrade2 = tkinter.Entry(
            self._frame_9, justify="center", width=0,)
        self.firstsub3 = tkinter.Entry(
            self._frame_10, justify="center", width=35,)
        self.firstcourse3 = tkinter.Entry(
            self._frame_11, justify="center", width=10,)
        self.firstcredit3 = tkinter.Entry(
            self._frame_12, justify="center", width=0,)
        self.firstgrade3 = tkinter.Entry(
            self._frame_13, justify="center", width=0,)
        self.firstsub4 = tkinter.Entry(
            self._frame_14, justify="center", width=35,)
        self.firstcourse4 = tkinter.Entry(
            self._frame_15, justify="center", width=10,)
        self.firstcredit4 = tkinter.Entry(
            self._frame_16, justify="center", width=0,)
        self.firstgrade4 = tkinter.Entry(
            self._frame_17, justify="center", width=0,)
        self.firstsub5 = tkinter.Entry(
            self._frame_54, justify="center", width=35,)
        self.firstcourse5 = tkinter.Entry(
            self._frame_53, justify="center", width=10,)
        self.firstcredit5 = tkinter.Entry(
            self._frame_52, justify="center", width=0,)
        self.firstgrade5 = tkinter.Entry(
            self._frame_51, justify="center", width=0,)

        self._label_22 = tkinter.Label(
            root, activebackground="#b66b6b", background="#b66b6b", font="{MS Sans Serif} 8 bold", text="Grade",)
        self._label_24 = tkinter.Label(
            root, activebackground="#b66b6b", background="#b66b6b", font="{MS Sans Serif} 8 bold", text="Grade Point",)
        self._label_25 = tkinter.Label(root, activebackground="#d7ffd7", background="#d7ffd7",
                                       font="{MS Sans Serif} 8 bold", text="O (Outstanding)",)
        self._label_47 = tkinter.Label(root, activebackground="#d7ffd7", background="#d7ffd7",
                                       font="{MS Sans Serif} 8 bold", padx=0, pady=0, text=10,)
        self._label_48 = tkinter.Label(root, activebackground="#d7ffd7", background="#d7ffd7",
                                       font="{MS Sans Serif} 8 bold", padx=0, pady=0, text="A+",)
        self._label_49 = tkinter.Label(root, activebackground="#d7ffd7", background="#d7ffd7",
                                       font="{MS Sans Serif} 8 bold", padx=0, pady=0, text=9,)
        self._label_50 = tkinter.Label(root, activebackground="#d7ffd7", background="#d7ffd7",
                                       font="{MS Sans Serif} 8 bold", padx=0, pady=0, text="A",)
        self._label_51 = tkinter.Label(root, activebackground="#d7ffd7", background="#d7ffd7",
                                       font="{MS Sans Serif} 8 bold", padx=0, pady=0, text=8,)
        self._label_52 = tkinter.Label(root, activebackground="#d7ffd7", background="#d7ffd7",
                                       font="{MS Sans Serif} 8 bold", padx=0, pady=0, text="B+",)
        self._label_53 = tkinter.Label(root, activebackground="#d7ffd7", background="#d7ffd7",
                                       font="{MS Sans Serif} 8 bold", padx=0, pady=0, text=7,)
        self._label_54 = tkinter.Label(root, activebackground="#d7ffd7", background="#d7ffd7",
                                       font="{MS Sans Serif} 8 bold", padx=0, pady=0, text="B",)
        self._label_55 = tkinter.Label(root, activebackground="#d7ffd7", background="#d7ffd7",
                                       font="{MS Sans Serif} 8 bold", padx=0, pady=0, text=6,)
        self._label_56 = tkinter.Label(root, activebackground="#d2ffd2", background="#d2ffd2",
                                       font="{MS Sans Serif} 8 bold", padx=0, pady=0, text="C+",)
        self._label_57 = tkinter.Label(root, activebackground="#d2ffd2", background="#d2ffd2",
                                       font="{MS Sans Serif} 8 bold", padx=0, pady=0, text=5,)
        self._label_58 = tkinter.Label(root, activebackground="#d2ffd2", background="#d2ffd2",
                                       font="{MS Sans Serif} 8 bold", padx=0, pady=0, text="C",)
        self._label_59 = tkinter.Label(root, activebackground="#d2ffd2", background="#d2ffd2",
                                       font="{MS Sans Serif} 8 bold", padx=0, pady=0, text=4,)
        self._label_4 = tkinter.Label(root, activebackground="#d2ffd2", background="#d2ffd2",
                                      font="{MS Sans Serif} 8 bold", padx=0, pady=0, text="E (Reappear)",)
 ...
 take steps for improvements""",
        ...
        self._label_31 = tkinter.Label(root, activebackground="#ff8f59", background="#ff8f59",font="{MS Sans Serif} 18 bold",
                                      text="""This project is made by 
                                      SANDEEP KUMAR 
                                      student of 
...
4. Finally Press CGPA.
5. CGPA is calculated using the formula given.
The grade point considered is for CURAJ students.
6. CGPA will be displayed along with helpful
...
********************************************************""",
        ...
        self._label_49.grid(in_=root, column=6, row=7, columnspan=2,
                            ipadx=0, ipady=0, padx=0, pady=0, rowspan=1, sticky="nsew")
        self._label_50.grid(in_=root, column=5, row=8, columnspan=1,
                            ipadx=0, ipady=0, padx=0, pady=0, rowspan=1, sticky="nsew")
        self._label_51.grid(in_=root, column=6, row=8, columnspan=2,
                            ipadx=0, ipady=0, padx=0, pady=0, rowspan=1, sticky="nsew")
        self._label_52.grid(in_=root, column=5, row=9, columnspan=1,
                            ipadx=0, ipady=0, padx=0, pady=0, rowspan=1, sticky="nsew")
        self._label_53.grid(in_=root, column=6, row=9, columnspan=2,
                            ipadx=0, ipady=0, padx=0, pady=0, rowspan=1, sticky="nsew")
        self._label_54.grid(in_=root, column=5, row=10, columnspan=1,
                            ipadx=0, ipady=0, padx=0, pady=0, rowspan=1, sticky="nsew")
        self._label_55.grid(in_=root, column=6, row=10, columnspan=2,
                            ipadx=0, ipady=0, padx=0, pady=0, rowspan=1, sticky="nsew")
        self._label_56.grid(in_=root, column=5, row=11, columnspan=1,
                            ipadx=0, ipady=0, padx=0, pady=0, rowspan=1, sticky="nsew")
        self._label_57.grid(in_=root, column=6, row=11, columnspan=2,
                            ipadx=0, ipady=0, padx=0, pady=0, rowspan=1, sticky="nsew")
        self._label_58.grid(in_=root, column=5, row=12, columnspan=1,
                            ipadx=0, ipady=0, padx=0, pady=0, rowspan=1, sticky="nsew")
        self._label_59.grid(in_=root, column=6, row=12, columnspan=2,
                            ipadx=0, ipady=0, padx=0, pady=0, rowspan=1, sticky="nsew")
        self._label_4.grid(in_=root, column=5, row=13, columnspan=1,
                           ipadx=0, ipady=0, padx=0, pady=0, rowspan=1, sticky="nsew")
        self._label_8.grid(in_=root, column=5, row=15, columnspan=1,
                           ipadx=0, ipady=0, padx=0, pady=0, rowspan=1, sticky="nsew")
        self._label_9.grid(in_=root, column=5, row=16, columnspan=1,
                           ipadx=0, ipady=0, padx=0, pady=0, rowspan=1, sticky="nsew")
        self._label_19.grid(in_=root, column=5, row=14, columnspan=1,
                            ipadx=0, ipady=0, padx=0, pady=0, rowspan=1, sticky="nsew")
        self._label_26.grid(in_=root, column=6, row=13, columnspan=2,
                            ipadx=0, ipady=0, padx=0, pady=0, rowspan=1, sticky="nsew")
        self._label_27.grid(in_=root, column=6, row=14, columnspan=2,
                            ipadx=0, ipady=0, padx=0, pady=0, rowspan=1, sticky="nsew")
        self._label_28.grid(in_=root, column=6, row=15, columnspan=2,
                            ipadx=0, ipady=0, padx=0, pady=0, rowspan=1, sticky="nsew")
        self._label_29.grid(in_=root, column=6, row=16, columnspan=2,
                            ipadx=0, ipady=0, padx=0, pady=0, rowspan=1, sticky="nsew")
        self.cgpa.grid(in_=root, column=5, row=17, columnspan=3,
                       ipadx=0, ipady=0, padx=0, pady=0, rowspan=2, sticky="nsew")
        self._label_7.grid(in_=root, column=8, row=5, columnspan=2,
                           ipadx=0, ipady=0, padx=0, pady=0, rowspan=2, sticky="nsew")
        self.open.grid(in_=root, column=5, row=3, columnspan=1,
                       ipadx=0, ipady=0, padx=0, pady=0, rowspan=1, sticky="nsew")
        self.save.grid(in_=root, column=6, row=3, columnspan=2,
                       ipadx=0, ipady=0, padx=0, pady=0, rowspan=1, sticky="nsew")
        self._label_23.grid(in_=root, column=5, row=4, columnspan=3,
                            ipadx=0, ipady=0, padx=0, pady=0, rowspan=1, sticky="nsew")
        self._label_32.grid(in_=root, column=8, row=7, columnspan=2,
                            ipadx=0, ipady=0, padx=0, pady=0, rowspan=3, sticky="nsew")
        self.cgpavalue.grid(in_=root, column=8, row=10, columnspan=2,
                            ipadx=0, ipady=0, padx=0, pady=0, rowspan=2, sticky="nsew")
        self.remark.grid(in_=root, column=8, row=12, columnspan=2,
                         ipadx=0, ipady=0, padx=0, pady=0, rowspan=1, sticky="nsew")
        self.remarkvalue.grid(in_=root, column=8, row=13, columnspan=2,
                              ipadx=0, ipady=0, padx=0, pady=0, rowspan=6, sticky="nsew")
        ...
        self._frame_51.grid_rowconfigure(1, weight=0, minsize=40, pad=0)
        self._frame_51.grid_columnconfigure(1, weight=0, minsize=40, pad=0)
        self._frame_52.grid_rowconfigure(1, weight=0, minsize=40, pad=0)
        self._frame_52.grid_columnconfigure(1, weight=0, minsize=40, pad=0)
        self._frame_53.grid_rowconfigure(1, weight=0, minsize=40, pad=0)
        self._frame_53.grid_columnconfigure(1, weight=0, minsize=40, pad=0)
        self._frame_54.grid_rowconfigure(1, weight=0, minsize=40, pad=0)
        self._frame_54.grid_columnconfigure(1, weight=0, minsize=40, pad=0)
    ...
    def cgpa_command(self, ):
        try:
            ...
            if (self.firstgrade1.get() in list) and (self.firstgrade2.get() in list) and (self.firstgrade3.get() in list) and \
                (self.firstgrade4.get() in list) and(self.firstgrade5.get() in list) and (int(self.firstcredit1.get()) in num) and (int(self.firstcredit2.get()) in num) and \
                (int(self.firstcredit3.get()) in num) and (int(self.firstcredit4.get()) in num) and (int(self.firstcredit5.get()) in num):

                a1, b1, c1, d1, n1 = self.firstcredit1.get(), self.firstcredit2.get(), self.firstcredit3.get(), self.firstcredit4.get(), self.firstcredit5.get()
                credit1.append(int(a1))
                credit1.append(int(b1))
                credit1.append(int(c1))
                credit1.append(int(d1))
                credit1.append(int(n1))
                print(credit1)
                e1, f1, g1, h1, m1 = self.firstgrade1.get(), self.firstgrade2.get(
                ), self.firstgrade3.get(), self.firstgrade4.get(), self.firstgrade5.get()
                e1 = e1.upper()
                grade1.append(e1)
                f1 = f1.upper()
                grade1.append(f1)
                ...
                y = 0
                while (y < 5):
                    if (grade1[y] == "O" or grade1[y] == "o"):
                        number = 10
                        grade1point.append(number)
                    elif (grade1[y] == "A+" or grade1[y] == "a+"):
                        number = 9
                        grade1point.append(number)
                    elif (grade1[y] == "A" or grade1[y] == "a"):
                        number = 8
                        grade1point.append(number)
                    elif (grade1[y] == "B+" or grade1[y] == "b+"):
                        number = 7
                        grade1point.append(number)
                    elif (grade1[y] == "B "or grade1[y] == "b"):
                        number = 6
                        grade1point.append(number)
                    elif (grade1[y] == "C+" or grade1[y] == "c+"):
                        number = 5
                        grade1point.append(number)
                    elif (grade1[y] == "C" or grade1[y] == "c"):
                        number = 4
                        grade1point.append(number)
                    elif (grade1[y] == "D+" or grade1[y] == "d+"):
                        number = 3
                        grade1point.append(number)
                    elif (grade1[y] == "D" or grade1[y] == "d"):
                        number = 2
                        grade1point.append(number)
                    elif (grade1[y] == "E" or grade1[y] == "e" or grade1[y] == "f" or grade1[y] == "F" or grade1[y] == "g" or grade1[y] == "G"):
                        number = 0
                        grade1point.append(number)
                    y = y + 1
                print(grade1point)
            ...
            if self.name.get() == "" and self.firstcredit1.get() == "" and self.firstcredit2.get() == "" and self.firstcredit3.get() == "" and\
                    self.firstcredit4.get() == "" and self.firstcredit5.get() == "" and self.firstgrade1.get() == "" and self.firstgrade2.get() == "" and self.firstgrade3.get() == "" and\
                    self.firstgrade4.get() == "" and self.firstgrade5.get() == "":
                messagebox.showwarning(
                    "Warning..!!", "Provide all required details\nthen Proceed.")
            else:
                self.cgp = (float(self.tgpa1))
...
******************************************************"""
            ...
            messagebox.showerror(
                "Error", "Something went wrong..!!!\nPlease contact Admin: +919680833221")
        pass
            ...
            if flag == 0:
                ...
                for i in range(0, len(record)):
                    if self.regno.get() == str(record[i][0]):
                        ...
                        self.firstsub5.delete(0, END)
                        self.firstsub5.insert(0, record[i+4][1])
                        self.firstcourse5.delete(0, END)
                        self.firstcourse5.insert(0, record[i+4][2])
    ...
    def save_command(self):
        try:
            ...
            cur = ob.cursor()
            # to create tables
            # cur.execute("""create table coursedetails(regno numeric, titlefirst char, codefirst char);""")
            ...
            if self.name.get() == "" or self.firstsub1.get() == "" or self.firstsub2.get() == "" or self.firstsub3.get() == "" or\
                    self.firstsub4.get() == "" or self.firstsub5.get() == "" or self.firstcourse1.get() == "" or self.firstcourse2.get() == "" or self.firstcourse3.get() == "" or\
                    self.firstcourse4.get() == "" or self.firstcourse5.get() == "" :
                print("Enter data before saving.")
                messagebox.showerror(
                    "Error..!!", "Enter all required data before saving..!!!")
            else:
                cur.execute("""select * from studentdetails;""")
                while True:
                    value = cur.fetchone()
                ...
                if self.regno.get() in list:
                    ...
                    cur.execute("""insert into coursedetails(regno, titlefirst, codefirst) values(?,?,?)""",
                                (int(self.regno.get()), self.firstsub1.get(), self.firstcourse1.get()))
                    cur.execute("""insert into coursedetails(regno, titlefirst, codefirst) values(?,?,?)""",
                                (int(self.regno.get()), self.firstsub2.get(), self.firstcourse2.get()))
                    cur.execute("""insert into coursedetails(regno, titlefirst, codefirst) values(?,?,?)""",
                                (int(self.regno.get()), self.firstsub3.get(), self.firstcourse3.get()))
                    cur.execute("""insert into coursedetails(regno, titlefirst, codefirst) values(?,?,?)""",
                                (int(self.regno.get()), self.firstsub4.get(), self.firstcourse4.get()))
                    cur.execute("""insert into coursedetails(regno, titlefirst, codefirst) values(?,?,?)""",
                                (int(self.regno.get()), self.firstsub5.get(), self.firstcourse5.get()))

                    # to insert data into studentdetails table
                    cur.execute("""insert into studentdetails(regno, name) values(?,?)""", (int(
                        self.regno.get()), self.name.get()))
